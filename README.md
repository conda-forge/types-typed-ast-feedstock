...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-typed-ast-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13177&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-typed-ast-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-typed-ast` can be installed with:

```
conda install types-typed-ast
```

It is possible to list all of the versions of `types-typed-ast` available on your platform with:
